    ...
    function unflatten(list, isChildNode, addChildNode, convertNode) {
        if (convertNode === undefined) {
            return reduce.call(list, function (tree, node) {
                var parentNode = find(list, function (parentNode) { return isChildNode(node, parentNode); });
            ...
            return reduce.call(mappedList_1, function (tree, node) {
                var parentNode = find(mappedList_1, function (parentNode) { return isChildNode(node.in, parentNode.in); });
                if (parentNode === undefined) {
                    tree.push(node.out);
                }
                else {
